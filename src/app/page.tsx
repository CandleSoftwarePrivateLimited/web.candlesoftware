...
const App: React.FC = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-100 to-pink-50 text-gray-800 font-inter antialiased">
      {/* Removed Tailwind CSS CDN script to fix "Synchronous scripts should not be used" error.
          In a real Next.js project, Tailwind CSS is typically configured via postcss.config.js and tailwind.config.js. */}
      {/* <script src="https://cdn.tailwindcss.com"></script> */}

      {/* Google Fonts - Inter for a clean professional look */}
      {/* Note: In a full Next.js app, custom fonts are typically added in layout.tsx (App Router) or _document.js (Pages Router)
          for optimal loading, rather than directly in a component. This is currently a warning in Vercel. */}
      <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap" rel="stylesheet" />

      {/* Global Custom CSS for animations and font-family */}
      <style>
        {`
        /* Applying Tailwind CSS utility classes directly to allow the preview to work,
           as the CDN script was removed to fix a Next.js build error.
           In a real Next.js project, Tailwind would be properly configured via build tools. */
        @tailwind base;
        @tailwind components;
        @tailwind utilities;
      ...
      <header className="fixed top-0 left-0 w-full bg-white bg-opacity-90 backdrop-blur-sm shadow-md z-50 p-4">
        <nav className="container mx-auto flex justify-between items-center px-4 sm:px-6 lg:px-8">
          {/* Logo */}
          <a href="#" className="flex items-center space-x-2 text-2xl font-bold text-orange-600 rounded-lg p-2 transition duration-300 hover:text-orange-700">
          ...
          <ul className="hidden md:flex space-x-8">
            <li><a href="#home" className="text-gray-700 hover:text-orange-600 transition-colors duration-300 font-medium px-3 py-2 rounded-md">Home</a></li>
            <li><a href="#services" className="text-gray-700 hover:text-orange-600 transition-colors duration-300 font-medium px-3 py-2 rounded-md">Services</a></li>
            <li><a href="#portfolio" className="text-gray-700 hover:text-orange-600 transition-colors duration-300 font-medium px-3 py-2 rounded-md">Portfolio</a></li>
            <li><a href="#about" className="text-gray-700 hover:text-orange-600 transition-colors duration-300 font-medium px-3 py-2 rounded-md">About</a></li>
            <li><a href="#contact" className="text-gray-700 hover:text-orange-600 transition-colors duration-300 font-medium px-3 py-2 rounded-md">Contact</a></li>
          </ul>

          {/* Mobile Menu Button (Hamburger) */}
          <div className="md:hidden">
            <button className="text-gray-700 focus:outline-none focus:ring-2 focus:ring-orange-500 rounded-md p-2">
      ...
      {/* Hero Section */}
      <section id="home" className="relative flex items-center justify-center min-h-screen bg-pink-500 text-white overflow-hidden py-24 sm:py-32">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight mb-6 animate-slide-in-top">
            Ignite Your Online Presence with <span className="text-yellow-300">Candle Web</span>
          </h1>
          ...
          <button className="bg-orange-400 text-white font-semibold px-8 py-4 rounded-full shadow-lg hover:bg-orange-500 hover:scale-105 transform transition duration-300 ease-in-out flex items-center justify-center mx-auto animate-fade-in">
      ...
      {/* Services Section */}
      <section id="services" className="py-20 sm:py-24 bg-purple-100">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl sm:text-4xl font-bold text-center text-orange-600 mb-12">Our Core Services</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 group">
              <div className="flex justify-center items-center w-16 h-16 bg-blue-200 text-blue-700 rounded-full mb-6 mx-auto group-hover:bg-blue-700 group-hover:text-white transition-colors duration-300">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 group">
              <div className="flex justify-center items-center w-16 h-16 bg-green-200 text-green-700 rounded-full mb-6 mx-auto group-hover:bg-green-700 group-hover:text-white transition-colors duration-300">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 group">
              <div className="flex justify-center items-center w-16 h-16 bg-yellow-200 text-yellow-700 rounded-full mb-6 mx-auto group-hover:bg-yellow-700 group-hover:text-white transition-colors duration-300">
      ...
      <section id="portfolio" className="py-20 sm:py-24 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl sm:text-4xl font-bold text-center text-orange-600 mb-12">Our Work</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-100 rounded-xl shadow-md overflow-hidden transform transition-transform duration-300 hover:scale-105">
              <img
                src="https://placehold.co/600x400/FFD1DC/FF69B4?text=Fun+Project+1" // Pink theme placeholder
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Interactive Storybook</h3>
                <p className="text-gray-600">Engaging digital storybooks designed to spark imagination for young minds.</p>
              </div>
            </div>
            {/* Placeholder Portfolio Item 2 */}
            <div className="bg-gray-100 rounded-xl shadow-md overflow-hidden transform transition-transform duration-300 hover:scale-105">
              <img
                src="https://placehold.co/600x400/ADD8E6/4682B4?text=Playful+App+2" // Light blue theme placeholder
                alt="Project Placeholder 2"
                className="w-full h-48 object-cover"
                onError={(e: React.SyntheticEvent<HTMLImageElement, Event>) => { e.currentTarget.onerror = null; e.currentTarget.src = 'https://placehold.co/600x400/D1D5DB/4B5563?text=Image+Load+Error'; }}
              />
              <div className="p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Learning Game Platform</h3>
                <p className="text-gray-600">Educational games that make learning fun and accessible for kids of all ages.</p>
              </div>
            </div>
            {/* Placeholder Portfolio Item 3 */}
            <div className="bg-gray-100 rounded-xl shadow-md overflow-hidden transform transition-transform duration-300 hover:scale-105">
              <img
                src="https://placehold.co/600x400/90EE90/32CD32?text=Creative+Site+3" // Light green theme placeholder
                alt="Project Placeholder 3"
                className="w-full h-48 object-cover"
                onError={(e: React.SyntheticEvent<HTMLImageElement, Event>) => { e.currentTarget.onerror = null; e.currentTarget.src = 'https://placehold.co/600x400/D1D5DB/4B5563?text=Image+Load+Error'; }}
              />
              <div className="p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Art & Craft Showcase</h3>
                <p className="text-gray-600">A vibrant platform for young artists to share their creative masterpieces.</p>
              </div>
            </div>
          </div>
          <div className="text-center mt-12">
            <a href="#" className="inline-flex items-center bg-orange-600 text-white font-semibold px-6 py-3 rounded-full shadow-md hover:bg-orange-700 transition-colors duration-300">
      ...
      <section id="about" className="py-20 sm:py-24 bg-purple-100">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-4xl">
          ...
          <div className="mt-12">
            <a href="#contact" className="inline-flex items-center bg-transparent border-2 border-orange-600 text-orange-600 font-semibold px-6 py-3 rounded-full hover:bg-orange-600 hover:text-white transition-colors duration-300">
      ...
      {/* Contact Section */}
      <section id="contact" className="py-20 sm:py-24 bg-pink-500 text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-6">
            <a href="mailto:info@candleweb.com" className="bg-orange-400 text-white font-semibold px-8 py-4 rounded-full shadow-lg hover:bg-orange-500 transform transition duration-300 ease-in-out flex items-center justify-center">
              <Mail className="mr-2 w-5 h-5" /> Email Us
            </a>
            <a href="tel:+1234567890" className="bg-transparent border-2 border-white text-white font-semibold px-8 py-4 rounded-full hover:bg-white hover:text-pink-500 transform transition duration-300 ease-in-out">
              Call Us: +1 (234) 567-890
            </a>
          </div>
          <div className="mt-12 text-pink-200">
            <p>123 Web Street, Digital City, DC 98765</p>
            <p className="mt-2">Follow us on social media:</p>
            <div className="flex justify-center space-x-6 mt-4">
              {/* Placeholder Social Icons */}
              <a href="#" className="text-white hover:text-pink-100 transition-colors duration-300">
      ...
      <footer className="bg-purple-600 text-white py-8">
        <div className="container mx-auto text-center px-4 sm:px-6 lg:px-8">
          <p className="text-purple-200">&copy; {new Date().getFullYear()} Candle Web. All rights reserved.</p>
